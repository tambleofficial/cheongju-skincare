...
적용된 대표 주소: https://cheongju-skincare.pages.dev
...
```xml
<url><loc>https://cheongju-skincare.pages.dev/blog/새-파일명</loc></url>
```

rss.xml의 </channel> 바로 앞:
```xml
<item><title>글 제목</title><link>https://cheongju-skincare.pages.dev/blog/새-파일명</link><guid isPermaLink="true">https://cheongju-skincare.pages.dev/blog/새-파일명</guid><description>글 요약</description></item>
```
